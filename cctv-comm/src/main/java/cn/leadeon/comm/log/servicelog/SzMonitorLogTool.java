 ...
 */
package cn.leadeon.comm.log.servicelog;
...
//	private static Log logger_6 = new Log("APPID_6");
	...
	public static void businessReqReciveLog(SzMonitorDomain domain){
		...
		/*消息标识*/
		buf.append(domain.getStep()).append(".").append(ONE).append(SEPRATOR);   
		/*请求代码分类*/
		buf.append(TWO).append(SEPRATOR);
		/*请求代码*/
		buf.append(serviceName+"-bossprovider").append(SEPRATOR);
		/*服务类型*/
	...
	public static void requestSendLog(SzMonitorDomain domain) {
		...
		/*消息标识*/
		buf_1.append(domain.getStep()).append(".").append(ONE).append(".").append(ONE).append(SEPRATOR);
		/*请求代码分类*/
		buf_1.append(TWO).append(SEPRATOR);
		/*请求代码*/
		buf_1.append(serviceName+"-bossprovider").append(APPID_LT);
	...
	public static void requestReciveLog(SzMonitorDomain domain){
		...
		buf_1.append(pid).append(SEPRATOR);
		/*消息标识*/
		buf_1.append(TWO).append(".").append(ONE).append(".").append(ONE).append(SEPRATOR);
		/*系统处理结果*/
		String isSuc = domain.getRetCode();
		String flag = ZERO;
		if (!SUCCESS.equals(isSuc)) {
		...
		/*特殊处理标志*/
		buf_1.append(ONE).append(APPID_LT);
		logger_3.staticInfo(buf_1.toString());
	}
